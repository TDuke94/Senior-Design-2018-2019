...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA2_PERIPHERAL_FREQMHZ {76.190483} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_3_GPIO [get_bd_intf_ports shield_dp26_dp41] [get_bd_intf_pins axi_gpio_3/GPIO]
  ...
  connect_bd_net -net axi_gpio_3_ip2intc_irpt [get_bd_pins axi_gpio_3/ip2intc_irpt] [get_bd_pins xlconcat_0/In2]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK2]
  connect_bd_net -net processing_system7_0_FCLK_CLK3 [get_bd_pins proc_sys_reset_2/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK3]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins proc_sys_reset_2/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  ...
  set_property PFM_NAME {vendor:lib:Arty_Z7_20:1.0} [get_files [current_bd_design].bd]
  set_property PFM.CLOCK {clk_out1 {id "1" is_default "false" proc_sys_reset "/proc_sys_reset_0"}} [get_bd_cells /clk_wiz_0]
  ...
  set_property PFM.CLOCK {FCLK_CLK0 {id "2" is_default "false" proc_sys_reset "/rst_ps7_0_100M"} FCLK_CLK1 {id "3" is_default "false" proc_sys_reset ""} FCLK_CLK2 {id "4" is_default "false" proc_sys_reset "/proc_sys_reset_1"} FCLK_CLK3 {id "5" is_default "false" proc_sys_reset "/proc_sys_reset_2"}} [get_bd_cells /processing_system7_0]
  set_property PFM.IRQ {In0 {} In1 {} In2 {}} [get_bd_cells /xlconcat_0]
